 ...
 * - FREE: 0 domains, 0 team members, 75 URLs/month, 30 QR/month, 5 files/month, 7-day team trial (1 member)
 * - PRO: 1 domain, 3 team members, 1000 URLs/month, 100 QR/month, 50 files/month, 7-day trial
 * - BUSINESS: 3 domains, 10 team members, 10000 URLs/month, 1000 QR/month, 500 files/month, 14-day trial
 * - BUSINESS_TRIAL: Same as BUSINESS but with trial period active
 */
public enum PlanPolicy {
    FREE("Free", 0, 0, 75, 30, 5, 7, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false),
    PRO("Pro", 1, 3, 1000, 100, 50, 7, true, true, true, false, true, false, true, true, true, true, true, true, true, true, true),
    BUSINESS("Business", 3, 10, 10000, 1000, 500, 14, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true),
    BUSINESS_TRIAL("Business Trial", 3, 10, 10000, 1000, 500, 14, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true);
    ...
    // URL Shortener Premium Features
    public boolean hasCustomAlias() { return customAlias; }
    public boolean hasPasswordProtection() { return passwordProtection; }
    public boolean hasLinkExpiration() { return linkExpiration; }
    public boolean hasClickLimits() { return clickLimits; }
    
    // QR Code Premium Features
    public boolean hasCustomQRColors() { return customQRColors; }
    public boolean hasQrLogo() { return qrLogo; }
    public boolean hasQrBranding() { return qrBranding; }
    public boolean hasAdvancedQRSettings() { return advancedQRSettings; }
    
    // File Upload Premium Features
    public boolean hasAdvancedFileSettings() { return advancedFileSettings; }
    ...
    public boolean hasFeature(String featureName) {
        switch (featureName.toLowerCase()) {
            case "customdomain": return hasCustomDomain();
            case "analytics": return hasAnalytics();
            case "teamcollaboration": return hasTeamCollaboration();
            case "whitelabel": return hasWhiteLabel();
            case "apiaccess": return hasApiAccess();
            case "prioritysupport": return hasPrioritySupport();
            case "customalias": return hasCustomAlias();
            case "passwordprotection": return hasPasswordProtection();
            case "linkexpiration": return hasLinkExpiration();
            case "clicklimits": return hasClickLimits();
            case "customqrcolors": return hasCustomQRColors();
            case "qrlogo": return hasQrLogo();
            case "qrbranding": return hasQrBranding();
            case "advancedqrsettings": return hasAdvancedQRSettings();
            case "advancedfilesettings": return hasAdvancedFileSettings();
    ...
    public String getUpgradeReason(String feature, Integer currentCount) {
        ...
        if (currentCount != null) {
            return String.format("You've reached your %s limit for the %s plan", feature.toLowerCase(), this.displayName);
        }
